...
- **Theorem 1** — Homeostatic stability: *N* ≤ ρ_eff/θ_death ≈ 4.93
...
|--------|-----------|-------------|--------|
| *N* | 4.00 ± 0.00 | ≤ 4.93 | ✓ T.1 verified |
| ω* | 0.625 ± 0.171 | 0.649 ± 0.10 | ✓ T.2 verified |
| *p*_conv | 1.00 | > 0.50 | ✓ T.3 verified |
| Hijack rate | 28.8% | — | Prediction C3 |
